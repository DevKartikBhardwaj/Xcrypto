import { Container, Box, RadioGroup, HStack, Radio, VStack, Text, Image, Stat, StatLabel, StatNumber, StatHelpText, StatArrow, Button, Badge, Progress } from '@chakra-ui/react'
...
export default function CoinDetails() {
    ...
    const btns = ["24h", "7d", "14d", "16d", "200d", "1y", "max"];
                ...
                loading ? <Loader /> :
                    <>
                        ...
                        <VStack spacing={"4"} p={"16"} alignItems="flex-start">
                            ...
                            <Image src={coin.image.large} w={"16"} objectFit="contain" h={"16"} />
